...
def get_metabolic_data(
    ...
    if sub_qc_split:
        ...
        return BaseData(meta_df[~qc_index], y_df[~qc_index]), BaseData(meta_df[qc_index], y_df[qc_index])
    return BaseData(meta_df, y_df)


if __name__ == "__main__":
    # for testing
    meta_file = "/home/zhangpeng/Project/Batch_Effect/NormAE/metabolomics_data/data.csv"
    sample_file = "/home/zhangpeng/Project/Batch_Effect/NormAE/batch_informatio/sample.csv"
