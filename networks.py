...
class SimpleCoder(nn.Module):
    ''' MLP '''
    def __init__(self, units, act=nn.LeakyReLU(), bn=True, dropout=0.0, final_act=None):
        '''
        args:
            units: list, the units for each layers, contain input layer and output layer;
